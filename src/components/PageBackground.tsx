    ...
    >
      ...
      <div
        ...
        style={{
          ...
          background: dark
            ...
            : "radial-gradient(circle, rgba(79,209,197,0.28) 0%, transparent 65%)",
        }}
      />
      ...
      <div
        ...
        style={{
          ...
          height: 88,
          borderRadius: 9999,
          border: dark ? "1.5px solid rgba(56,201,188,0.15)" : "1.5px solid rgba(29,158,117,0.12)",
          top: "13%",
          right: "19%",
        }}
      />
      <div
        ...
        style={{
          ...
          height: 130,
          borderRadius: 9999,
          border: dark ? "1.5px solid rgba(56,201,188,0.1)" : "1.5px solid rgba(79,209,197,0.09)",
          top: "44%",
          left: "3%",
          animationDelay: "-4s",
        }}
      ...
      <div
        ...
        style={{
          ...
          height: 60,
          borderRadius: 9999,
          border: dark ? "1px solid rgba(255,201,51,0.14)" : "1px solid rgba(245,158,11,0.12)",
          bottom: "22%",
          right: "28%",
          animationDelay: "-7s",
        }}
      ...
      <div
        ...
        style={{
          ...
          height: 5,
          borderRadius: 9999,
          background: dark ? "rgba(56,201,188,0.5)" : "rgba(79,209,197,0.4)",
          bottom: "15%",
          right: "10%",
          animationDelay: "-10s",
        }}
